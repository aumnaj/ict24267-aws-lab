...
### 📝 LAB QUIZ — แบบทดสอบปลายภาค
- [ส่วนที่ 1: EC2 (ข้อ 1–5)](#สวนที่-1-ec2-ข้อ-1-5)
- [ส่วนที่ 2: RDS (ข้อ 6–10)](#สวนที่-2-rds-ข้อ-6-10)
- [ส่วนที่ 3: Lambda & Function as a Service (ข้อ 11–15)](#สวนที่-3-lambda--function-as-a-service-ข้อ-11-15)
- [ส่วนที่ 4: Integration, Security & Monitoring (ข้อ 16–20)](#สวนที่-4-integration-security--monitoring-ข้อ-16-20)
- [📊 เฉลยสรุป LAB QUIZ](#-เฉลยสรุป-lab-quiz)
...
def get_db_credentials():
    ...
    (ฟรี และปลอดภัยกว่าการเก็บใน Environment Variables)
    """
